...
- PCB: 1x `shinsanwaswitch_PCB` 1mm thickness (KiCad 5.99+ (5.99.0-11575-g46338403e7), release build required for exporting Gerber files or take Gerber files archive in `Gerber/shinsanwaswitch.zip`)
